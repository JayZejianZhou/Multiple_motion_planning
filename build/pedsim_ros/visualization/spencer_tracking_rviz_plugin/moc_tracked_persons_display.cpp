...
#include "../../../../src/pedsim_ros/visualization/spencer_tracking_rviz_plugin/src/tracked_persons_display.h"
...
static const char qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedPersonsDisplay[] = {
...
const QMetaObjectExtraData spencer_tracking_rviz_plugin::TrackedPersonsDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject spencer_tracking_rviz_plugin::TrackedPersonsDisplay::staticMetaObject = {
    { &PersonDisplayCommon<spencer_tracking_msgs::TrackedPersons>::staticMetaObject, qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedPersonsDisplay,
      qt_meta_data_spencer_tracking_rviz_plugin__TrackedPersonsDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &spencer_tracking_rviz_plugin::TrackedPersonsDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedPersonsDisplay))
        return static_cast<void*>(const_cast< TrackedPersonsDisplay*>(this));
    typedef PersonDisplayCommon<spencer_tracking_msgs::TrackedPersons> QMocSuperClass;
