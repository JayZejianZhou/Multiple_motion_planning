...
#include "../../../../src/pedsim_ros/visualization/spencer_tracking_rviz_plugin/src/tracked_groups_display.h"
...
static const char qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedGroupsDisplay[] = {
...
const QMetaObjectExtraData spencer_tracking_rviz_plugin::TrackedGroupsDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject spencer_tracking_rviz_plugin::TrackedGroupsDisplay::staticMetaObject = {
    { &PersonDisplayCommon<spencer_tracking_msgs::TrackedGroups>::staticMetaObject, qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedGroupsDisplay,
      qt_meta_data_spencer_tracking_rviz_plugin__TrackedGroupsDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &spencer_tracking_rviz_plugin::TrackedGroupsDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_spencer_tracking_rviz_plugin__TrackedGroupsDisplay))
        return static_cast<void*>(const_cast< TrackedGroupsDisplay*>(this));
    typedef PersonDisplayCommon<spencer_tracking_msgs::TrackedGroups> QMocSuperClass;
