...
static const char qt_meta_stringdata_GroupGazeForce[] = {
    "GroupGazeForce\0\0valueIn\0"
    "onForceFactorGroupGazeChanged(double)\0"
};
...
const QMetaObjectExtraData GroupGazeForce::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GroupGazeForce::staticMetaObject = {
    { &Force::staticMetaObject, qt_meta_stringdata_GroupGazeForce,
      qt_meta_data_GroupGazeForce, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GroupGazeForce::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupGazeForce))
        return static_cast<void*>(const_cast< GroupGazeForce*>(this));
