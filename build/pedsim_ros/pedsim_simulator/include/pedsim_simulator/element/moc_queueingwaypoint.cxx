...
static const char qt_meta_stringdata_QueueingWaypoint[] = {
    "QueueingWaypoint\0\0x,y\0"
...
const QMetaObjectExtraData QueueingWaypoint::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QueueingWaypoint::staticMetaObject = {
    { &Waypoint::staticMetaObject, qt_meta_stringdata_QueueingWaypoint,
      qt_meta_data_QueueingWaypoint, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QueueingWaypoint::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QueueingWaypoint))
        return static_cast<void*>(const_cast< QueueingWaypoint*>(this));
