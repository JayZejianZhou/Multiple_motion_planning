...
static const char qt_meta_stringdata_IndividualWaypointPlanner[] = {
    "IndividualWaypointPlanner\0"
};
...
const QMetaObjectExtraData IndividualWaypointPlanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject IndividualWaypointPlanner::staticMetaObject = {
    { &WaypointPlanner::staticMetaObject, qt_meta_stringdata_IndividualWaypointPlanner,
      qt_meta_data_IndividualWaypointPlanner, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &IndividualWaypointPlanner::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IndividualWaypointPlanner))
        return static_cast<void*>(const_cast< IndividualWaypointPlanner*>(this));
