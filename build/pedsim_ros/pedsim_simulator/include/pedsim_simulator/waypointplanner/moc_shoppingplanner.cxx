...
static const char qt_meta_stringdata_ShoppingPlanner[] = {
    "ShoppingPlanner\0\0lostAttraction()\0"
    "loseAttraction()\0"
};
...
const QMetaObjectExtraData ShoppingPlanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ShoppingPlanner::staticMetaObject = {
    { &WaypointPlanner::staticMetaObject, qt_meta_stringdata_ShoppingPlanner,
      qt_meta_data_ShoppingPlanner, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ShoppingPlanner::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ShoppingPlanner))
        return static_cast<void*>(const_cast< ShoppingPlanner*>(this));
