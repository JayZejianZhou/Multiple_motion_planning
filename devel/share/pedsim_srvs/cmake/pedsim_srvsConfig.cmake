...
if(NOT "/home/zejian/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pedsim_srvs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zejian/catkin_ws/src/pedsim_ros/pedsim_srvs/${idir}'.  Ask the maintainer 'batman <okal@cs.uni-freiburg.de>' to fix it.")
    endif()
