...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_h.pack(self.agent_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.agent_id,) = _struct_h.unpack(str[start:end])
      return self
...
class GetAgentStateResponse(genpy.Message):
  _md5sum = "cfa8b5815a010c9347af8d1228f11b35"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2h.pack(_x.state.id, _x.state.type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.id, _x.state.type,) = _struct_2h.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.state.social_state = str[start:end].decode('utf-8')
      else:
        self.state.social_state = str[start:end]
      _x = self
      start = end
      end += 104
      (_x.state.pose.position.x, _x.state.pose.position.y, _x.state.pose.position.z, _x.state.pose.orientation.x, _x.state.pose.orientation.y, _x.state.pose.orientation.z, _x.state.pose.orientation.w, _x.state.twist.linear.x, _x.state.twist.linear.y, _x.state.twist.linear.z, _x.state.twist.angular.x, _x.state.twist.angular.y, _x.state.twist.angular.z,) = _struct_13d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetAgentState(object):
  ...
  _md5sum = '8c8c95013c66d17bff79517e7bef2c6f'
