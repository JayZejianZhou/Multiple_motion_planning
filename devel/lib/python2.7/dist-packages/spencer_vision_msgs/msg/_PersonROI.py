...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Q4IB.pack(_x.detection_id, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.detection_id, _x.roi.x_offset, _x.roi.y_offset, _x.roi.height, _x.roi.width, _x.roi.do_rectify,) = _struct_Q4IB.unpack(str[start:end])
