...
"""autogenerated by genpy from supervision_msgs/GuideGroupAction.msg. Do not edit."""
import sys
...
class GuideGroupAction(genpy.Message):
  _md5sum = "430dfc6e7eb2a07e758bb2f2a795a87f"
  _type = "supervision_msgs/GuideGroupAction"
...
"""
  ...
  _slot_types = ['supervision_msgs/GuideGroupActionGoal','supervision_msgs/GuideGroupActionResult','supervision_msgs/GuideGroupActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GuideGroupAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = supervision_msgs.msg.GuideGroupActionGoal()
      if self.action_result is None:
        self.action_result = supervision_msgs.msg.GuideGroupActionResult()
      if self.action_feedback is None:
        self.action_feedback = supervision_msgs.msg.GuideGroupActionFeedback()
    else:
      self.action_goal = supervision_msgs.msg.GuideGroupActionGoal()
      self.action_result = supervision_msgs.msg.GuideGroupActionResult()
      self.action_feedback = supervision_msgs.msg.GuideGroupActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.group_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.details
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.group_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.group_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.details = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.details = str[start:end]
      return self
