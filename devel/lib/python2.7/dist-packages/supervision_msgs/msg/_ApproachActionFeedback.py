...
"""autogenerated by genpy from supervision_msgs/ApproachActionFeedback.msg. Do not edit."""
import sys
...
class ApproachActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "supervision_msgs/ApproachActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','supervision_msgs/ApproachFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ApproachActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = supervision_msgs.msg.ApproachFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = supervision_msgs.msg.ApproachFeedback()
