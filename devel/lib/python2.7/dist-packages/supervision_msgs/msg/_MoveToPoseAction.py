...
"""autogenerated by genpy from supervision_msgs/MoveToPoseAction.msg. Do not edit."""
import sys
...
class MoveToPoseAction(genpy.Message):
  _md5sum = "32d614e31a5742e02ce6902617e03b30"
  _type = "supervision_msgs/MoveToPoseAction"
...
"""
  ...
  _slot_types = ['supervision_msgs/MoveToPoseActionGoal','supervision_msgs/MoveToPoseActionResult','supervision_msgs/MoveToPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = supervision_msgs.msg.MoveToPoseActionGoal()
      if self.action_result is None:
        self.action_result = supervision_msgs.msg.MoveToPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = supervision_msgs.msg.MoveToPoseActionFeedback()
    else:
      self.action_goal = supervision_msgs.msg.MoveToPoseActionGoal()
      self.action_result = supervision_msgs.msg.MoveToPoseActionResult()
      self.action_feedback = supervision_msgs.msg.MoveToPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.last_pose)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.last_pose:
        _v3 = val1.position
        _x = _v3
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_feedback.feedback.last_pose = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Pose()
        _v7 = val1.position
        _x = _v7
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
        self.action_feedback.feedback.last_pose.append(val1)
      return self
