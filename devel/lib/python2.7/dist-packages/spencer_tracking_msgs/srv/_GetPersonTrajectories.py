...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.max_age.secs, _x.max_age.nsecs,) = _struct_2i.unpack(str[start:end])
      self.max_age.canon()
      return self
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.trajectories:
        buff.write(_struct_Q.pack(val1.track_id))
        ...
        for val2 in val1.trajectory:
          ...
          _x = val2
          buff.write(_struct_BQ.pack(_x.is_occluded, _x.detection_id))
          _v2 = val2.pose
          _v3 = _v2.pose
          _v4 = _v3.position
          _x = _v4
          ...
          buff.write(_struct_36d.pack(*_v2.covariance))
          _v6 = val2.twist
          _v7 = _v6.twist
          _v8 = _v7.linear
          _x = _v8
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.track_id,) = _struct_Q.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.trajectory = []
        for i in range(0, length):
          ...
          (_x.is_occluded, _x.detection_id,) = _struct_BQ.unpack(str[start:end])
