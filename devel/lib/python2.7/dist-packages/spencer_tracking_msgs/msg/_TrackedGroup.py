...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Q2i7d.pack(_x.group_id, _x.age.secs, _x.age.nsecs, _x.centerOfGravity.pose.position.x, _x.centerOfGravity.pose.position.y, _x.centerOfGravity.pose.position.z, _x.centerOfGravity.pose.orientation.x, _x.centerOfGravity.pose.orientation.y, _x.centerOfGravity.pose.orientation.z, _x.centerOfGravity.pose.orientation.w))
      buff.write(_struct_36d.pack(*self.centerOfGravity.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.group_id, _x.age.secs, _x.age.nsecs, _x.centerOfGravity.pose.position.x, _x.centerOfGravity.pose.position.y, _x.centerOfGravity.pose.position.z, _x.centerOfGravity.pose.orientation.x, _x.centerOfGravity.pose.orientation.y, _x.centerOfGravity.pose.orientation.z, _x.centerOfGravity.pose.orientation.w,) = _struct_Q2i7d.unpack(str[start:end])
      start = end
      end += 288
      self.centerOfGravity.covariance = _struct_36d.unpack(str[start:end])
      start = end
      end += 4
