...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Q10d.pack(_x.composite_detection_id, _x.mean_confidence, _x.max_confidence, _x.min_confidence, _x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.composite_detection_id, _x.mean_confidence, _x.max_confidence, _x.min_confidence, _x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w,) = _struct_Q10d.unpack(str[start:end])
      start = end
      end += 288
      ...
      for i in range(0, length):
        ...
        _v5.covariance = _struct_36d.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
