  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.elements:
        _x = val1
        buff.write(_struct_Q3d.pack(_x.composite_detection_id, _x.mean_confidence, _x.max_confidence, _x.min_confidence))
        _v1 = val1.pose
        _v2 = _v1.pose
        _v3 = _v2.position
        _x = _v3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.composite_detection_id, _x.mean_confidence, _x.max_confidence, _x.min_confidence,) = _struct_Q3d.unpack(str[start:end])
        _v9 = val1.pose
        _v10 = _v9.pose
        _v11 = _v10.position
        _x = _v11
