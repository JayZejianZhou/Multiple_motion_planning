  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.infos:
        _x = val1
        buff.write(_struct_Q5d.pack(_x.track_id, _x.innovation, _x.CpXX, _x.CpYY, _x.CXX, _x.CYY))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.track_id, _x.innovation, _x.CpXX, _x.CpYY, _x.CXX, _x.CYY,) = _struct_Q5d.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
