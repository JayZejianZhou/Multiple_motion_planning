  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.boxes:
        _x = val1
        buff.write(_struct_Qf2i2If.pack(_x.track_id, _x.person_height, _x.x, _x.y, _x.w, _x.h, _x.depth))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.track_id, _x.person_height, _x.x, _x.y, _x.w, _x.h, _x.depth,) = _struct_Qf2i2If.unpack(str[start:end])
