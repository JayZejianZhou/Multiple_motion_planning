...
"""autogenerated by genpy from animated_marker_msgs/AnimatedMarkerArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import animated_marker_msgs.msg
import geometry_msgs.msg
import genpy
import std_msgs.msg

class AnimatedMarkerArray(genpy.Message):
  _md5sum = "89605f0f161f0c65a2f0254d60ec80a5"
  _type = "animated_marker_msgs/AnimatedMarkerArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """AnimatedMarker[] markers
...
"""
  __slots__ = ['markers']
  _slot_types = ['animated_marker_msgs/AnimatedMarker[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AnimatedMarkerArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
        _x = val1
        buff.write(_struct_Bf.pack(_x.frame_locked, _x.animation_speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = animated_marker_msgs.msg.AnimatedMarker()
        _v9 = val1.header
        start = end
        end += 4
        ...
        (_x.frame_locked, _x.animation_speed,) = _struct_Bf.unpack(str[start:end])
