...
"""autogenerated by genpy from spencer_nav_msgs/NavigationPlanRequestTopological.msg. Do not edit."""
import sys
...
class NavigationPlanRequestTopological(genpy.Message):
  _md5sum = "bdf33f222874d371fce6c706611c4e29"
  _type = "spencer_nav_msgs/NavigationPlanRequestTopological"
...
"""
  ...
  _slot_types = ['std_msgs/Header','spencer_mapping_msgs/TopologicalMapNode','spencer_mapping_msgs/TopologicalMapNode','spencer_tracking_msgs/DetectedPersons','spencer_tracking_msgs/TrackedPersons','spencer_tracking_msgs/TrackedGroups','spencer_nav_msgs/NavParams']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigationPlanRequestTopological, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.start is None:
        self.start = spencer_mapping_msgs.msg.TopologicalMapNode()
      if self.goal is None:
        self.goal = spencer_mapping_msgs.msg.TopologicalMapNode()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_I3dI3d3I.pack(_x.start.id, _x.start.position.x, _x.start.position.y, _x.start.position.z, _x.goal.id, _x.goal.position.x, _x.goal.position.y, _x.goal.position.z, _x.detectedPersons.header.seq, _x.detectedPersons.header.stamp.secs, _x.detectedPersons.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start.id, _x.start.position.x, _x.start.position.y, _x.start.position.z, _x.goal.id, _x.goal.position.x, _x.goal.position.y, _x.goal.position.z, _x.detectedPersons.header.seq, _x.detectedPersons.header.stamp.secs, _x.detectedPersons.header.stamp.nsecs,) = _struct_I3dI3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
_struct_I3dI3d3I = struct.Struct("<I3dI3d3I")
