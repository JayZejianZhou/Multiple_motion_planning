...
int main(int argc,char **argv){
  ...
  //set the initial shape type of a cube
  ...
  while(ros::ok()){
    ...
    //set the marker typr. Initially this is CUBE, and cycles between that and SPHERE, ARROW, and CYLINDER
    marker.type=shape;
    ...
    //Set the color -- be sure to set alpha to somthing non-zero
    marker.color.r=0.01f;
    marker.color.g=1.0f;
    marker.color.b=0.0f;
    marker.color.a=1.0;
