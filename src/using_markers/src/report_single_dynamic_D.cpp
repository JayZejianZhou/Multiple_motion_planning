...
void map_init(){
  ...
  obstacle2.scale.x=3.0;
  obstacle2.scale.y=6.0;
  obstacle2.scale.z=4.0;
...
//    m_jay.set_obstacle(14,17);
    ...
    m_stella.find_path(0,0);
    Node * temp_stella=&m_stella.nodes[m_stella.start_x][m_stella.start_y];
    geometry_msgs::Point p_stella;
    p_stella.z=0;
    while(temp_stella->get_previous()!=&m_stella.nodes[m_stella.goal_x][m_stella.goal_y]){
